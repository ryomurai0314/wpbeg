		...
		<header class="header">
			...
			<div class="menu-gmenu-container">
				<ul class="menu">
					...
					<li class="menu-item current_page_item"><a href="page.html">About</a></li>
				</ul>
			</div>
		</header>
		<div class="c-wrap">
			<div class="c-grid">
				<div class="p-contents">
					<div class="post">
						<h2 class="post__ttl"><a href="#">このブログについて</a></h2><img class="post__eyecatch" src="images/eyecatch/001.png" alt="アイキャッチ">
